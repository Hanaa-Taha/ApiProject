    ...
    public partial class DbsmartagricultureContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblCategory>(entity =>
            {
                ...
                entity.HasIndex(e => e.CategoryName, "UQ__Tbl_Cate__8517B2E024832BE2")
                    .IsUnique();
            ...
            modelBuilder.Entity<TblMembers>(entity =>
            {
                ...
                entity.HasIndex(e => e.LastName, "UQ__Tbl_Memb__7449F39903552E4B")
                    .IsUnique();

                entity.HasIndex(e => e.EmailId, "UQ__Tbl_Memb__7ED91ACEDC594EB5")
                    .IsUnique();
            ...
            modelBuilder.Entity<TblProduct>(entity =>
            {
                ...
                entity.HasIndex(e => e.ProductName, "UQ__Tbl_Prod__DD5A978A4FD147D8")
                    .IsUnique();
            ...
            modelBuilder.Entity<TblRoles>(entity =>
            {
                ...
                entity.HasIndex(e => e.RoleName, "UQ__Tbl_Role__8A2B6160582CE7B7")
                    .IsUnique();
